...
-- 4. Add foregin key relationship between `inventory` and `classification`
...
-- 6. Insert data into `classification` table
...
-- 7. Insert data into `inventory` table
